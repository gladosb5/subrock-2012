...
<html dir="ltr" lang="en"><!-- machid: nLThsU052OXJEdFhuSUlhRVNpclZvcXVHVzdCTlRrSWNDN1R0dnBObzJRRnRWZlpJWTl1SjRB -->
  ...
  <p class="largeText">Sorry for the interruption. We have been receiving a large volume of requests from your network. To continue with your SubRock experience, please enter the verification code below.</p>
  ...
  <div id="footer-container">
    ...
    <div id="footer-main">
      <ul id="footer-links-primary">
        ...
        <li><a href="/t/about_subrock">About</a></li>
